    ...
    return (
        <NavBar>
            <>
                ...
                {loading || lecture.speakers === undefined || lecture.participants=== undefined|| lecture.tags === undefined ? (<p>Carregando...</p>): (
                    <section className={style.cadastro_palestra_section}>
                        ...
                        <article className={style.cadastro_palestra_article_button}>
                            ...
                            <button onClick={editar} className={style.cadastro_palestra_button}>Editar</button>
                        </article>
                    </section>
                )}
            </>
