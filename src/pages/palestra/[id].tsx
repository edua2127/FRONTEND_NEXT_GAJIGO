                ...
                <main>
                    <section className={style.lecture_section}>
                        <article className={style.lecture_article_cadastro_and_voltar}>
                            ...
                            <button
                                className={style.lecture_button_voltar}
                                onClick={() => Router.back()}
                            >
                                Voltar
                            </button>
                                ...
                                <tbody>
                                    {lectures.length > 0 &&
                                        lectures.map((lecture) => {
                                            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                            // @ts-ignore
                                            const idLocal: string = lecture._links.self.href
                                                .split('/')
                                                .pop()
                                            return (
                                                <tr
                                                    key={idLocal}
                                                    className={style.lecture_table_tr}
                                                >
                                                    <td className={style.lecture_table_td}>
                                                        {lecture.name}
                                                    </td>
                                                    <td className={style.lecture_table_td}>
                                                        {lecture.description}
