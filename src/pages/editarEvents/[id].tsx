                    ...
                    <section className={style.editar_events_section}>
                        <article className={style.editar_events_article_checkbox}>
                            <label className={style.editar_events_label_checkbox}>
                                ...
                                <input className={style.editar_events_checkbox} type="checkbox" checked={event.active}
                        ...
                        <article className={style.editar_events_article}>
                            <label className={style.editar_events_label}>
                                ...
                                <input className={style.editar_input} type="datetime-local"
                                       value={event.interval.startDate}
                                       onChange={(e) => setEvent({
                                           ...event,
                                           interval: {...event.interval, startDate: e.target.value}
                                       })}/>
                            </label>
                            <label className={style.editar_events_label}>
                                ...
                                <input className={style.editar_input} type="datetime-local"
                                       ...
                                       onChange={(e) => setEvent({
                                           ...event,
                                           interval: {...event.interval, endDate: e.target.value}
                                       })}/>
                            </label>
                        </article>
                        <article className={style.editar_events_article}>
