                        ...
                        <article className={style.cadastro_palestra_article}>
                            <label className={style.cadastro_palestra_label}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setLecture({ ...lecture, attendanceMode: e.target.value })
                                    }
                                >
                            ...
                            <label className={style.cadastro_palestra_label}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setLecture({ ...lecture, language: e.target.value })
                                    }
                                >
                                    <option value=''>Selecione</option>
                                    {languages.length > 0 &&
                                        languages.map((language, index) => {
                                            return (
                                                <option
                                                    key={index}
                                                    value={language._links.self.href}
                                                >
                                                    {language.name}
                                                </option>
                                            )
                        ...
                        <article className={style.cadastro_palestra_article}>
                            <label className={style.cadastro_palestra_label}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setLecture({ ...lecture, speakers: [e.target.value] })
                                    }
                                >
                                    <option value=''>Selecione</option>
                                    {palestrantes.length > 0 &&
                                        palestrantes.map((palestrante, index) => {
                                            return (
                                                <option
                                                    key={index}
                                                    value={palestrante._links.self.href}
                                                >
                                                    {palestrante.name}
                                                </option>
                                            )
                            ...
                            <label className={style.cadastro_palestra_label}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setLecture({ ...lecture, tags: [e.target.value] })
                                    }
                                >
                                    <option value=''>Selecione</option>
                                    {tag.length > 0 &&
                        ...
                        <article className={style.cadastro_palestra_article}>
                            <label className={style.cadastro_palestra_label}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setLecture({ ...lecture, participants: [e.target.value] })
                                    }
                                >
                                    <option value=''>Selecione</option>
                                    {participantes.length > 0 &&
                                        participantes.map((participante, index) => {
                                            return (
                                                <option
                                                    key={index}
                                                    value={participante._links.self.href}
                                                >
                                                    {participante.name}
                                                </option>
                                            )
